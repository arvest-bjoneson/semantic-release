...
import { addNote, getGitHead, getTagHead, isBranchUpToDate, push, pushNotes, tag, verifyPush, verifyFetch } from "./lib/git.js";
...
async function run(context, plugins) {
  ...
  try {
    try {
      await verifyFetch(options.repositoryUrl, context.branch.name, { cwd, env });
